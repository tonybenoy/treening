...
- **Coach T (AI Coach):** Chat with your personal workout coach that knows your training history. Ask for advice, log workouts through chat, or get a suggested routine. Powered by WebLLM running entirely in your browser via WebGPU — no server, no API keys, fully offline after a one-time model download. Choose from 4 models in Settings based on your device capability.
...
- **AI:** [WebLLM](https://webllm.mlc.ai/) (multiple models via WebGPU, optional)
