...
pub fn landing_page() -> Html {
    ...
    html! {
        <div class="px-4 py-6 pb-24 space-y-8 max-w-lg mx-auto transition-colors duration-200">
            ...
            // CTA
            <button
                class="w-full py-4 bg-blue-600 text-white rounded-xl text-lg font-bold hover:bg-blue-700 active:bg-blue-800 transition neu-btn"
                onclick={go_workout}
            ...
            <div class="space-y-4">
                ...
                <ol class="space-y-4 text-sm">
                    <li class="flex gap-3">
                        <span class="flex-shrink-0 w-7 h-7 bg-blue-600 text-white rounded-full flex items-center justify-center font-bold text-sm neu-chip">{"1"}</span>
                        <div>
                    ...
                    <li class="flex gap-3">
                        <span class="flex-shrink-0 w-7 h-7 bg-blue-600 text-white rounded-full flex items-center justify-center font-bold text-sm neu-chip">{"2"}</span>
                        <div>
                    ...
                    <li class="flex gap-3">
                        <span class="flex-shrink-0 w-7 h-7 bg-blue-600 text-white rounded-full flex items-center justify-center font-bold text-sm neu-chip">{"3"}</span>
                        <div>
                    ...
                    <li class="flex gap-3">
                        <span class="flex-shrink-0 w-7 h-7 bg-blue-600 text-white rounded-full flex items-center justify-center font-bold text-sm neu-chip">{"4"}</span>
                        <div>
            ...
            <div class="flex gap-3">
                <Link<Route> to={Route::Faq} classes="flex-1 py-3 bg-gray-100 dark:bg-gray-800 text-gray-800 dark:text-gray-200 rounded-xl text-center text-sm font-bold hover:bg-gray-200 dark:hover:bg-gray-700 neu-btn transition-colors">
                    {"FAQ"}
                </Link<Route>>
                <Link<Route> to={Route::Settings} classes="flex-1 py-3 bg-gray-100 dark:bg-gray-800 text-gray-800 dark:text-gray-200 rounded-xl text-center text-sm font-bold hover:bg-gray-200 dark:hover:bg-gray-700 neu-btn transition-colors">
                    {"Settings"}
                </Link<Route>>
            </div>
        </div>
